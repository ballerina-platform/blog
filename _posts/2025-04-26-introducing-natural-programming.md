...
For the curious, a set of samples of Natural Programming in Ballerina is available [here](https://github.com/ballerina-platform/module-ballerina-np/tree/main/examples). 
