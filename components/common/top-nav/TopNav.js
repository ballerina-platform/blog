...
const TopNav = (props) => {
  ...
  const MenuItems = [
    ...
    <Dropdown.Item category='case studies' href={`https://ballerina.io/case-studies/wso2`} className={styles.dropDownItem} key='10'>WSO2</Dropdown.Item>,
    <Dropdown.Item category='case studies' href={`https://ballerina.io/case-studies/mosip`} className={styles.dropDownItem} key='10'>MOSIP</Dropdown.Item>
  ];
